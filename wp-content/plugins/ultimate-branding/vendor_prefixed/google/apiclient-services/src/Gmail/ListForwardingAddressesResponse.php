 ...
 * the License.
 */
namespace Branda_Vendor\Google\Service\Gmail;

class ListForwardingAddressesResponse extends \Branda_Vendor\Google\Collection
{
...
\class_alias(ListForwardingAddressesResponse::class, 'Branda_Vendor\\Google_Service_Gmail_ListForwardingAddressesResponse');