...
class ListSmimeInfoResponse extends \Branda_Vendor\Google\Collection
{
...
\class_alias(ListSmimeInfoResponse::class, 'Branda_Vendor\\Google_Service_Gmail_ListSmimeInfoResponse');