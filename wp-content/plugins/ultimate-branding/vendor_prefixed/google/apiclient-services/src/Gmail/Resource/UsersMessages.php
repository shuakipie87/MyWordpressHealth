 ...
 * the License.
 */
namespace Branda_Vendor\Google\Service\Gmail\Resource;

use Branda_Vendor\Google\Service\Gmail\BatchDeleteMessagesRequest;
use Branda_Vendor\Google\Service\Gmail\BatchModifyMessagesRequest;
use Branda_Vendor\Google\Service\Gmail\ListMessagesResponse;
use Branda_Vendor\Google\Service\Gmail\Message;
use Branda_Vendor\Google\Service\Gmail\ModifyMessageRequest;
/**
 ...
 *  </code>
 */
class UsersMessages extends \Branda_Vendor\Google\Service\Resource
{
    /**
...
\class_alias(UsersMessages::class, 'Branda_Vendor\\Google_Service_Gmail_Resource_UsersMessages');