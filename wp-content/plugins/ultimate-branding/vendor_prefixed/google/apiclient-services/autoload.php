...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('Branda_Vendor\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['Branda_Vendor\\Google\\Client' => 'Google_Client', 'Branda_Vendor\\Google\\Service' => 'Google_Service', 'Branda_Vendor\\Google\\Service\\Resource' => 'Google_Service_Resource', 'Branda_Vendor\\Google\\Model' => 'Google_Model', 'Branda_Vendor\\Google\\Collection' => 'Google_Collection'];
