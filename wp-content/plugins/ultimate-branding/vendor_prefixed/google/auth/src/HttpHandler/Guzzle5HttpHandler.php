 ...
 */
namespace Branda_Vendor\Google\Auth\HttpHandler;

use Exception;
use Branda_Vendor\GuzzleHttp\ClientInterface;
use Branda_Vendor\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use Branda_Vendor\GuzzleHttp\Promise\Promise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('Branda_Vendor\\GuzzleHttp\\Promise\\Promise')) {
