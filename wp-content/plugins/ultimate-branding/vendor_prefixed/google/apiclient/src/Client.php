 ...
 */
namespace Branda_Vendor\Google;

use Branda_Vendor\Google\AccessToken\Revoke;
use Branda_Vendor\Google\AccessToken\Verify;
use Branda_Vendor\Google\Auth\ApplicationDefaultCredentials;
use Branda_Vendor\Google\Auth\Cache\MemoryCacheItemPool;
use Branda_Vendor\Google\Auth\CredentialsLoader;
use Branda_Vendor\Google\Auth\FetchAuthTokenCache;
use Branda_Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use Branda_Vendor\Google\Auth\OAuth2;
use Branda_Vendor\Google\Auth\Credentials\ServiceAccountCredentials;
use Branda_Vendor\Google\Auth\Credentials\UserRefreshCredentials;
use Branda_Vendor\Google\AuthHandler\AuthHandlerFactory;
use Branda_Vendor\Google\Http\REST;
use Branda_Vendor\GuzzleHttp\Client as GuzzleClient;
use Branda_Vendor\GuzzleHttp\ClientInterface;
use Branda_Vendor\GuzzleHttp\Ring\Client\StreamHandler;
use Branda_Vendor\Psr\Cache\CacheItemPoolInterface;
use Branda_Vendor\Psr\Http\Message\RequestInterface;
use Branda_Vendor\Psr\Log\LoggerInterface;
use Branda_Vendor\Monolog\Logger;
use Branda_Vendor\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Branda_Vendor\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\\Branda_Vendor\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\Branda_Vendor\GuzzleHttp\ClientInterface::VERSION')) {
