 ...
 */
namespace Branda_Vendor\Google\Http;

use Branda_Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use Branda_Vendor\Google\Client;
use Branda_Vendor\Google\Task\Runner;
use Branda_Vendor\Google\Service\Exception as GoogleServiceException;
use Branda_Vendor\GuzzleHttp\ClientInterface;
use Branda_Vendor\GuzzleHttp\Exception\RequestException;
use Branda_Vendor\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if ($response instanceof \Branda_Vendor\GuzzleHttp\Message\ResponseInterface) {
