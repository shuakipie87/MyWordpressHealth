...
namespace Branda_Vendor\Google\AuthHandler;
...
use Branda_Vendor\Google\Auth\Middleware\ScopedAccessTokenMiddleware;
use Branda_Vendor\Google\Auth\Middleware\SimpleMiddleware;
