...
namespace Branda_Vendor\Psr\Log\Test;

use Branda_Vendor\Psr\Log\LoggerInterface;
use Branda_Vendor\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Branda_Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Branda_Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Branda_Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
