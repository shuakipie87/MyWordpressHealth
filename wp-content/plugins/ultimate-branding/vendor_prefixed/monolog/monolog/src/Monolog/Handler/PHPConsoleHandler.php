...
use Branda_Vendor\Monolog\Utils;
use Branda_Vendor\PhpConsole\Connector;
use Branda_Vendor\PhpConsole\Handler;
use Branda_Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('Branda_Vendor\\PhpConsole\\Connector')) {
