 ...
 */
namespace Branda_Vendor\Composer;

use Branda_Vendor\Composer\Autoload\ClassLoader;
use Branda_Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Branda_Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
