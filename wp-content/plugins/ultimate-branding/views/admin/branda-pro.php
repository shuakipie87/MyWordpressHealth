...
<div class="sui-upgrade-page">
	...
	<div class="sui-upgrade-page__container">
		<div class="sui-upgrade-page-features__items">
			...
			<div class="sui-upgrade-page-features__item">
				...
				<p><?php esc_html_e( "You'll be delighted with Branda Pro! 🙂 However, if you're not happy in any way, we have a 100%, 30-day money-back guarantee. Cancel within the first 30 days and we'll refund your money, no questions asked.", 'ub' ); ?></p>
			</div>
		</div>
	</div>
	<div class="sui-upgrade-page-cta">
		<div class="sui-upgrade-page-cta__inner">
			...
			<p><?php esc_html_e( "97% of customers are happy with WPMU DEV's service, and it's a great time to join them! Branda users can unlock our full suite of Pro WP plugins, time-saving site management, and integrated client billing/management tools.", 'ub' ); ?></p>
